...
- Write in the first person as a builder sharing your own run ("I measured", "on my key"), never claiming to speak for Anthropic. Open with a plain, concrete line (a "quick tip"), never a vague filler like "quick one".
