...
The sharpest edge: a cost lever for fan-out tool calls, measured on our own key.
...
To run it on your own tool, edit `programmatic_tool_calling/my_tool.py` and run `make programmatic_tool_calling` again.
