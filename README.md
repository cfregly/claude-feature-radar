...
feature hit. The full saved output is [`edges/programmatic-tool-calling/sample.txt`](edges/programmatic-tool-calling/sample.txt).
...
```bash
make programmatic-tool-calling          # estimated $0.08 on Sonnet, needs ANTHROPIC_API_KEY
