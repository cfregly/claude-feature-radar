...
I ran it using my API key over a small doc set. On Haiku 4.5, all 8 answers came back with a pointer that resolves: the source text at that character range equals the quoted text, and the quote does not count against output tokens. Live cost $0.011.
