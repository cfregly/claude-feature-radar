...
class Model:
    ...
    verified: str = "2026-06-24"     # date this table's prices were last checked against the live pages


# Verified 2026-06-24 against platform.claude.com (pricing, effort, adaptive-thinking) and a live call.
# Claude Mythos 5 also supports programmatic tool calling and is priced like Fable 5 on the live page, but it is limited
...
MODELS: dict[str, Model] = {
    ...
    # 2026-06-24 against the providers' pricing pages (developers.openai.com/api/docs/pricing,
    ...
    "gpt-mini": Model(
        # The cheapest tier the docs recommend as a capable multi-step tool driver. Nano is cheaper
        # but a weaker driver, so this remains a first-class comparison row.
